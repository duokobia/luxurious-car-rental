...
import airPix from "../../assets/img/airport-transfer-Mauritius.jpeg";
import intercityTrips from "../../assets/img/intercity-trips.jpeg";
import weddingTrips from "../../assets/img/wedding-trips.jpeg";
import businessTrips from "../../assets/img/business-trips.jpeg";
      ...
      <div>
        <div className="servicesCard-row row gx-5 px-5 mb-5">
          <card className="card servicesCard col d-flex align-items-center justify-content-center flex-row p-3">
            <img src={airPix} alt="Airport-transfers" />
          ...
          <card className="card servicesCard col d-flex align-items-center justify-content-center flex-row p-3">
            <img src={intercityTrips} alt="Intercity-trips" />
            <div className="card-body">
        ...
        <div className="servicesCard-row row gx-5 px-5 mb-5">
          <card className="card servicesCard col d-flex align-items-center justify-content-center flex-row p-3">
            <img src={weddingTrips} alt="Wedding-events" />
            <div className="card-body">
          ...
          <card className="card servicesCard col d-flex align-items-center justify-content-center flex-row p-3">
            <img src={businessTrips} alt="Business-meetings" />
            <div className="card-body">
